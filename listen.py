                ...
                if motion == 'stop':
                    ...
                    if left_speed > right_speed:
                        ...
                        if flag_new_pid_cycle:
                            ...
                            pid_right = PID(kp, ki, kd, setpoint=left_encoder.value, output_limits=(-1,0), starting_output=right_speed)
                            flag_new_pid_cycle = False
                    else:
                        dir = "left"
                        if flag_new_pid_cycle:
                            pid_left = PID(kp, ki, kd, setpoint=right_encoder.value, output_limits=(-1,0), starting_output=left_speed)
                            flag_new_pid_cycle = False
                    if dir == "left":
